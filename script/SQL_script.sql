...
CREATE TABLE IF NOT EXISTS `neldam_an`.`season_fields` (
  ...
  `lease_type` ENUM('PRO_HA', 'PRO_FIELD') NULL,
...
START TRANSACTION;
USE `neldam_an`;
INSERT INTO `neldam_an`.`users` (`id`, `username`, `password`, `enabled`, `active_season`, `first_name`, `last_name`, `mail`, `country`, `state`) VALUES (DEFAULT, 'neldam', 'puma1234', 1, 1, 'Mateusz', 'Gocz', 'msgocz@gmail.com', NULL, NULL);
INSERT INTO `neldam_an`.`users` (`id`, `username`, `password`, `enabled`, `active_season`, `first_name`, `last_name`, `mail`, `country`, `state`) VALUES (DEFAULT, 'test', 'test', 1, 2, 'Jan', 'Kowalski', 'kow@mail.pl', NULL, NULL);
...
START TRANSACTION;
USE `neldam_an`;
INSERT INTO `neldam_an`.`season_fields` (`id`, `season_id`, `field_id`, `plant`, `variety`, `sowing_cost`, `lease_cost`, `sowing_type`, `lease_type`, `tons_pro_ha`, `tone_price`, `tax_cost`, `tax_type`, `user_id`) VALUES (DEFAULT, 1, 1, 'Rzepak', 'KWS 24 Rasp', 0, 0, 'PRO_HA', 'PRO_HA', 0, 0, 0, 'PRO_HA', 0);
INSERT INTO `neldam_an`.`season_fields` (`id`, `season_id`, `field_id`, `plant`, `variety`, `sowing_cost`, `lease_cost`, `sowing_type`, `lease_type`, `tons_pro_ha`, `tone_price`, `tax_cost`, `tax_type`, `user_id`) VALUES (0, DEFAULT, DEFAULT, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, DEFAULT);
